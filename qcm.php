...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        header class="qcm-header" { margin-bottom: 40px; text-align: center; }
...
<div class="container">
    ...
    <form action="calcule note.php" method="POST">
...
<script>
    ...
    window.addEventListener('blur', () => { document.getElementById('warning').style.display = 'block'; });
</script>
</body>
</html>